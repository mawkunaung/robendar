                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-info detail" data-id="{{$row->id}}"><i class="fas fa-exclamation-triangle"></i></a>

                                                <a href="{{route('rooms.edit',$row->id)}}" class="btn btn-warning"><i class="fas fa-user-edit"></i></a>

                                            <form action="{{route('rooms.destroy',$row->id)}}" method="post" onsubmit="return confirm('Are you sure?')" class="d-inline">
                                                @csrf
                                                @method('DELETE')
